...
<head>
    ...
    <title>Tableau de bord Autorité | NoVi</title>
    ...
    <div class="flex flex-col flex-1 overflow-hidden">
        <div class="flex-1 overflow-auto p-6 bg-gray-50">
            <div id="dashboard-content">
                <h1 class="text-2xl font-bold text-purple-700 mb-6">Tableau de bord Autorité</h1>
                <div class="bg-white rounded-lg shadow p-6">Bienvenue sur votre espace autorité.</div>
            </div>
